<?php
  ...
  while($row = $result->fetch_array()) 
  {
    ...
    $sql2 = "SELECT * FROM user_acc WHERE username ='$username'";
    ...
    $sql8 = "SELECT * FROM team_project WHERE status='Already Checked' AND team_name1 ='$team'";

    $result8 = $conn->query($sql8);
	
	$row8 = mysqli_num_rows($result8);

    $sql9 = "SELECT * FROM team_project WHERE team_name1 ='$team'";
    ...
    $sql10 = "SELECT * FROM weekly_report WHERE report_status='Signed' AND team_name1 ='$team'";

    $result10 = $conn->query($sql10);
	
	$row10 = mysqli_num_rows($result10);

    $sql11 = "SELECT * FROM weekly_report WHERE team_name1 ='$team'";
