<?php
  ...
  include('db/dbconnection.php');
   ...
   date_default_timezone_set('Asia/Singapore');
	...
	}else if($currentTime <= "08:15" && $currentTime >= "07:45")
	{
	...
	}else if($currentTime <= "07:44" && $currentTime >= "00:01"){
		...
		$sql2 = "INSERT INTO attendance (company, user_acc_id, date_in, time_in, date_out, time_out, hrs_today,remark_time_in, remark, hrs_added, hrs_left) VALUES ('$company','$user_id','$currentDate','$absent_time_in','$currentDate','$absent_time_out
		',0,'$remark1','Time out Successful',0,'$rqrd_hrs')";
	}
    $response = array();
