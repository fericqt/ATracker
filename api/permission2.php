    ...
    if ($result->num_rows > 0) {
      ...
      while($row = $result->fetch_array()) {
				...
				if ($conn->query($sql2) === TRUE) {
	                    ...
	                    $mail->isHTML(true);	
	                    $message = "<div style='border-left-width: 7px; border-left-style: solid; border-left-color: #0071BD; background-color: #d4dbd5; border-radius: 5px; width:650px;'><h4><b><p style='padding:15px 10px 15px 10px;'>Dear ".$name.",<br><br>Good Day! Our team had decided to decline your application.<br><br> 
	                    Reason for the declined: " .$reasontext. "<br><br>Kind regards,<br><br><u>".$staff_name."</u><br><i>UIP ATTENDANCE TRACKER STAFF</i></p></b></h4></div>";
