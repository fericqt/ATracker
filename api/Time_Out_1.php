<?php
    ...
    $sql2 = "UPDATE attendance SET time_out = '$currentTime' , date_out = '$currentDate' , remark = 'Time out Successful (Overtime)', hrs_today = '$today_hrs' WHERE remark='$remark' and att_id='$lastID' and user_acc_id ='$user_id'";
	...
	if (mysqli_query($conn, $sql2)) {
		...
		{
		    $hrs_left = 0;
		    $remark_finished = "Time out Successful (Congratulations Intern)";
		}else{
		    $remark_finished = "Time out Successful (Overtime)";
		}
		
		
		$sql6 = "UPDATE attendance SET hrs_left = '$hrs_left', hrs_added = '$hrs_added',remark = '$remark_finished' WHERE remark='Time out Successful (Overtime)' and att_id='$lastID' and user_acc_id ='$user_id'";
