<?php
	...
	include("db/dbconnection.php");
        ...
        {
            $user_id = $row2["intern_info_id"];
        }
        }

            $sql = "UPDATE intern_info SET intern_status='$intern_status' where intern_info_id='$user_id'";
              if ($conn->query($sql) === TRUE) 
              {
                    $sql1 = "DELETE FROM reported_intern WHERE user_acc_id='$id'";
