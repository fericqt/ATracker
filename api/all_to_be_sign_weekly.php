<?php
	...
	include("db/dbconnection.php");
     ...
     $sql4 = "SELECT * FROM user_acc, team where user_acc.user_acc_id=team.leader_id";
    ...
    $sql = "SELECT * FROM team, weekly_report, user_acc WHERE user_acc.user_acc_id=weekly_report.user_acc_id AND team.team_id=weekly_report.team_name1 AND weekly_report.report_status='Unsign' Order BY weekly_report_id ASC";
