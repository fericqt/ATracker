<?php
	...
	if (mysqli_query($conn, $sql2)) {
		...
		if($hrs_left <= 0)
		{
		    ...
		    $remark_finished = "Time out Successful";
		}
		
		
		$sql6 = "UPDATE attendance SET hrs_left = '$hrs_left', hrs_added = '$hrs_added',remark = '$remark_finished' WHERE remark='Time out Successful' and att_id='$lastID' and user_acc_id ='$user_id'";
