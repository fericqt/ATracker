<?php
 ...
 if(isset($_POST['email'])){
   ...
   date_default_timezone_set('Asia/Singapore');
	...
	if($currentTime > "15:16" && $currentTime <= "15:30")
	{
		$remark1 = "1 hr late";
		$one_hr_late_time_in = "16:00";
	...
	}else if($currentTime >= "15:31" && $currentTime <= "17:00")
	{
		$remark1 = "2 hrs late";
		$two_hr_late_time_in = "17:00";
	...
	}else if($currentTime <= "15:15" && $currentTime >= "14:45")
	{
		$remark1 = "On time";
		$on_time = $currentTime;
