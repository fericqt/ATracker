<?php
    ...
    $sql = "SELECT * FROM team, user_acc, weekly_report where team.leader_id=user_acc.user_acc_id AND weekly_report.team_name=team.team_name AND weekly_report.user_acc_id=user_acc.user_acc_id AND weekly_report.report_status='Unsign' AND weekly_report.user_acc_id='".$user_acc_id."'";
