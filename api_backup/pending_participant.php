<?php
    ...
    $sql = "SELECT * FROM user_acc, attended_webinar, webinar where user_acc.user_acc_id=attended_webinar.user_acc_id AND attended_webinar.webinar_id=webinar.webinar_id AND attended_webinar.status_payment='In-Process' AND user_acc.usertype='Intern' AND attended_webinar.webinar_id='".$id."'";
