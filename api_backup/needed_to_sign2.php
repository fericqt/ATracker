<?php
    ...
    $sql = "SELECT * FROM team, user_acc, weekly_report where team.leader_id=user_acc.user_acc_id AND weekly_report.team_name=team.team_name AND weekly_report.user_acc_id=user_acc.user_acc_id AND weekly_report.report_status='Signed' AND weekly_report.user_acc_id='".$user_acc_id."'";
    ...
    if ($result->num_rows > 0) {
      ...
      while($row = $result->fetch_array()) {
        ...
        if($row["co_leader_id"]==0)
        {
            ...
            $view_weekly_report["Status"] = "<label class='badge badge-light'><strong> style='color:#000000'".$row["report_status"]."</strong></label>";
